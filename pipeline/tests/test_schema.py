...
GOOD_BUILDING = {
    ...
    "roof_source": "heuristic", "roof_color": "roof_flat", "roof_color_source": "ortho", "wall_color": "brick", "type": "yes",
...
def test_unknown_roof_color_source():
    bad = {**GOOD_BUILDING, "roof_color_source": "vibes"}
    problems = validate_feature("buildings", bad)
    assert any("roof_color_source" in p for p in problems)
